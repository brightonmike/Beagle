...
class Authentication {
    ...
    authorize(credentials) {
        console.log(credentials.installed.client_id);
        ...
        return new Promise((resolve, reject)=>{
            ...
            if(process.env.HEROKU) {
                console.log('Checking Heroku for config...');
                // Heroku always has our config stored
                oauth2Client.credentials = JSON.parse(process.env.GOOGLE_SHEETS_API);
