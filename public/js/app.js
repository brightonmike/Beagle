...
var _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }(); // import dummyData from './dummydata';


var _lighthouse = __webpack_require__(2);

var _lighthouse2 = _interopRequireDefault(_lighthouse);

var _pally = __webpack_require__(3);

var _pally2 = _interopRequireDefault(_pally);

var _keyscores = __webpack_require__(4);

var _keyscores2 = _interopRequireDefault(_keyscores);

var _charts = __webpack_require__(5);
    ...
    _createClass(SiteReport, [{
        ...
        value: function init() {
            var data = this.data,
                ...
                lhAuditContainer = this.lhAuditContainer,
                lhAudit = this.lhAudit,
                pa11yAuditContainer = this.pa11yAuditContainer,
            ...
            _lighthouse2.default.create(lhAuditContainer, lhAudit, veryGood, good, average, poor);
            _pally2.default.create(pa11yAuditContainer, pa11yAudit, veryGood, good, average, poor);
            _keyscores2.default.get(newJob, previousJob, rankings, veryGood, good, average, poor);
            _charts2.default.create(data);
...
module.exports = {
    create: function create(lhAuditContainer, lhAudit, veryGood, good, average, poor) {
...
module.exports = {
    create: function create(pa11yAuditContainer, pa11yAudit, veryGood, good, average, poor) {
...
module.exports = {
    get: function get(newJob, previousJob, rankings, veryGood, good, average, poor) {
        var tr = $('.js-row');
        var graphDataNew = [],
            graphDataOld = [];
